...
function kickstart_styles_init() {
	...
	wp_enqueue_style( 'kickstart-style-responsive', get_template_directory_uri() . '/css/media-queries.css' );
}
...
add_image_size( 'gkl_startseitenTeaser', 350, 210, true ); // 256 * 256 pixels, cropped
add_image_size( 'gkl_thumbnail', 250, 300, false ); 
...
// Widgetbereiche einrichten

if ( function_exists('register_sidebar') )
register_sidebar(array('name'=>'Lebenshilfe',
'before_widget' => '<div id="%1$s" class="box widget %2$s">',
'after_widget' => '</div>',
'before_title' => '<h4>',
'after_title' => '</h4>',
));
register_sidebar(array('name'=>'headNav',
'before_widget' => '',
'after_widget' => '',
'before_title' => '<h4>',
'after_title' => '</h4>',
